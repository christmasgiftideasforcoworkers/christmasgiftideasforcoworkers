...
jQuery(document).ready(function() {
    ...
    var expert_author_dropdownToggle = jQuery('.navbar-nav.main-nav .dropdown > a.nav-link');
    expert_author_dropdownToggle.after('<button type="button" class="dropdown-icon"></button>');
    expert_author_dropdownToggle.removeAttr('data-bs-toggle').removeAttr('data-bs-target').removeAttr('aria-expanded').removeAttr('data-bs-name').removeAttr('aria-haspopup');
    ...
    jQuery(window).on('resize', expert_author_desktopmenu);
    function expert_author_desktopmenu() {
